from numpy import any, array, count_nonzero, where, zeros
...
with open("day11.txt", "r") as file:
    ...
    while (steps < MAX_STEPS):
        ...
        total_flashes = total_flashes + count_nonzero(final_flash_locations)
    ...
    print(f"Total Flashes after {MAX_STEPS} steps: {total_flashes}")